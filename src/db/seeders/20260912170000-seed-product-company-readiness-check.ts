...
const formData = {
    ...
    title: 'Let’s check what may be stopping you from getting better interview calls.',
    subTitle:
...
const steps: SeedStep[] = [
    {
        ...
        helperText:
            'Our team will use this to contact you for your product-company readiness call.',
        questions: [
            {
        ...
        questions: [
            ...
            },
            {
                ...
                options: [
                    ...
                    { optionLabel: '1–2 years', optionValue: '1-2', score: 12, sortOrder: 2 },
                    { optionLabel: '2–4 years', optionValue: '2-4', score: 20, sortOrder: 3 },
                    { optionLabel: '4–7 years', optionValue: '4-7', score: 20, sortOrder: 4 },
                    { optionLabel: '7+ years', optionValue: '7-plus', score: 15, sortOrder: 5 },
                ],
            },
        ],
    },
        ...
        questions: [
            {
                ...
                questionText: 'What is happening in your job search right now?',
                placeholder: null,
                ...
                options: [
                    {
                        optionLabel: 'I am applying but not getting enough interview calls',
                        optionValue: 'applying-not-getting-enough-calls',
                        score: 20,
                        sortOrder: 1,
                    },
                    {
                        optionLabel: 'I am getting calls but not clearing interviews',
                        optionValue: 'getting-calls-not-clearing-interviews',
                        score: 20,
                        sortOrder: 2,
                    },
                    {
                        optionLabel: 'I am not sure which companies or roles to target',
                        optionValue: 'not-sure-which-companies-or-roles',
                        score: 12,
                        sortOrder: 3,
                    },
                    {
                        optionLabel: 'I have not started applying yet but want to switch soon',
                        optionValue: 'not-started-applying-yet',
                        score: 14,
                        sortOrder: 4,
                    },
                    {
                        optionLabel: 'I am applying randomly without a clear strategy',
                        optionValue: 'applying-randomly-without-strategy',
                        score: 16,
                        sortOrder: 5,
                    },
                ],
    ...
    },
    {
        ...
        questions: [
            {
                questionKey: 'mainGap',
                questionText: 'What do you feel is your biggest interview-readiness gap?',
                placeholder: null,
                questionType: QuestionType.RADIO,
                isRequired: true,
                sortOrder: 1,
                options: [
                    ...
                    },
                    {
                        ...
                        optionValue: 'projects-and-profile-depth',
                        score: 14,
                        sortOrder: 3,
                    },
                    {
                        optionLabel: 'Interview communication and confidence',
                        optionValue: 'interview-communication-and-confidence',
                        score: 13,
                        sortOrder: 4,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        optionValue: 'no-clear-preparation-structure',
                        score: 15,
                        sortOrder: 6,
                    },
                ],
        ...
        questions: [
            {
                ...
                questionText: 'What kind of role are you trying to move into?',
                placeholder: null,
                questionType: QuestionType.RADIO,
                isRequired: true,
                sortOrder: 1,
                options: [
                    {
                        optionLabel: 'Product company software engineering role',
                        optionValue: 'product-company-software-engineering-role',
                        score: 12,
                        sortOrder: 1,
                    },
                    {
                        optionLabel: 'Backend engineering role',
                        optionValue: 'backend-engineering-role',
                        score: 10,
                        sortOrder: 2,
                    },
                    {
                        optionLabel: 'Fullstack engineering role',
                        optionValue: 'fullstack-engineering-role',
                        score: 10,
                        sortOrder: 3,
                    },
                    {
                        optionLabel: 'AI-native software engineering role',
                        optionValue: 'ai-native-software-engineering-role',
                        score: 12,
                        sortOrder: 4,
                    },
                    {
    ...
    {
        stepNo: 7,
        title: 'How soon do you want to seriously work on your next switch?',
        helperText:
            'This helps us prioritize serious candidates for strategy calls.',
        questions: [
            {
                questionKey: 'urgency',
                questionText: 'How soon do you want to seriously work on your next switch?',
                placeholder: null,
                questionType: QuestionType.RADIO,
                isRequired: true,
                sortOrder: 1,
        ...
        questions: [
            {
                ...
                questionText: 'Can you invest in a structured career program if it is the right fit?',
                placeholder: null,
                questionType: QuestionType.RADIO,
                isRequired: true,
                sortOrder: 1,
                options: [
                    {
                        optionLabel: 'Yes, I can invest if the program is right for me',
